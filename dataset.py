...
class ImageStandardizer(object):
    ...
    def fit(self, X):
        ...
        # print(f"{self.image_mean.shape}")
        # print(f"{self.image_std.shape}")

        return np.concatenate((self.image_mean, self.image_std))
    ...
    def transform(self, X):
        ...
        assert self.image_mean is not None
        assert self.image_std is not None
...
class LandmarksDataset(Dataset):
    ...
    def __init__(self, partition, task="target", augment=True):
